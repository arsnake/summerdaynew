<?php include 'page_parts/header.php'; ?>
    ...
    <div class="row">
        <div class="inrow">
            ...
            <?php
                $owners = [
                  ['name' => 'Олексій Фокарді', 'image' => 'owner_avatar_1_1.jpg', 'description' => 'Директор з розвитку', 'text' => 'Світ не стоїть на місці і тільки нові підходи з індивідуальним баченням все частіше дозволяють досягти необхідних результатів. Понад 15 років набутого досвіду переконали нас, що найкращим пріоритетом є довгострокові перспективи, довіра клієнтів і надійна репутація. Ми використовуємо досвід, сучасні технології і безпечні рішення. Будуємо майбутнє саме для вас. '],
                  ['name' => 'Іван Жокін', 'image' => 'owner_avatar_3.jpg', 'description' => 'Директор з виробництва', 'text' => 'Будівництво - це комплексний, кропіткий процес, що вимагає вправності, вміння та розуміння. Вся наша команда, від проєктувальника до муляра, - це професіонали своєї справи. Гарантуючи бездоганну якість, ми можемо з гордістю стверджувати, що наша нерухомість стане комфортною і безпечною оселею для кожної сім\'ї. '],
            ...
            ?>
            <div class="owners-reviews" style="display: none;">
