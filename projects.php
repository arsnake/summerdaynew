...
<div class="row">
        <div class="inrow">
			...
			<div class="about">
               <p>Купуючи або орендуючи апартаменти, Ви отримуєте повний комплекс обслуговування за найвищими світовими стандартами, адже у нас є гарний досвід у цій справі. </p>
				<p>Наша Керуюча Компанія візьме на себе повний комплекс із оренди та обслуговування ваших апартаментів. </p>
