<div class="row">
    <div class="inrow">
        ...
        $news = [
            ...
            ['date' => '31 грудня 2020', 'url' => 'news-5', 'name' => 'Новий рік', 'image' => 'news-5.jpg', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Дорогі друзі!!! 2020 рік завершується, і хоч він був нелегким для усіх нас, ми проводимо його із гідністю та теплими спогадами. Щиро вітаємо Вас із Новим Роком та Різдвом Христовим...'],
            ['date' => '1 листопада 2020', 'url' => 'news-4', 'name' => 'Оновлення сайту', 'image' => 'news-4.jpg', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Світ дуже швидко змінюється, і ми разом із ним теж. Сьогодні наша группа розробників та дизайнерів нарешті завершила усі роботи з повного оновлення дизайну...'],
            ...
            ['date' => '01 жовтня 2020', 'url' => 'news-2', 'name' => 'Початок підготовки до будівництва', 'image' => 'news-2.jpg', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Ми із великою повагою ставимось до наших інвесторів та гостей, тому усі будівельні роботи, пов&#39;язані із великою технікою та підвищеним шумом, проводимо...'],
