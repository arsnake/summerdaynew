<div class="row">
    <div class="inrow">
        ...
        $news = [
            ...
            ['date' => '31 грудня 2020', 'url' => 'news-5', 'name' => 'Новий рік', 'image' => 'news-5.jpg', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Дорогі друзі!!! Щиро вітаємо Вас із Новим Роком та Різдвом Христовим.  2020 рік був дійсно викликом для усіх нас, але ми із гідністю пережили його і входимо...'],
