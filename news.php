<?php include 'page_parts/header.php'; ?>
    ...
    <div class="row">
        <div class="inrow">
            ...
            <?php
            $news = [
                ['date' => '1 листопада 2020', 'url' => 'news-4', 'name' => 'Оновлення сайту', 'image' => 'news-4.webp', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Світ дуже швидко змінюється, і ми разом із ним теж. Сьогодні наша группа розробників та дизайнерів нарешті завершила усі роботи з повного оновлення дизайну та функціоналу сайту. Незабаром ми ще додамо декілька дуже цікавих ...'],
                ['date' => '14 жовтня 2020', 'url' => 'news-3', 'name' => 'День українського козацтва', 'image' => 'news-3.webp', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Цього дня українці святкують одразу три свята. Перше- Свято Покрови Божої Матері, друге- День українського козацтва, і наймолодше- День захисника України.'],
                ['date' => '01 жовтня 2020', 'url' => 'news-2', 'name' => 'Початок підготовки до будівництва', 'image' => 'news-2.webp', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Ми із великою повагою ставимось до наших інвесторів та гостей, тому усі будівельні роботи, пов&#39;язані із великою технікою та підвищеним шумом, проводимо у період виключно із 1 жовтня по 1 травня. Із 1 жовтня...'],
                ['date' => '23 вересня 2020', 'url' => 'news-1', 'name' => 'Нове відео', 'image' => 'news-1.webp', 'company_name' => 'apartments', 'company_logo' => 'logo-g.png', 'text' => 'Зустрічайте наше нове відео, у якому ми розповідаємо про життя та устрій нашого Комплексу Grand Family Apartments. Детальніше переглянути відео можна на ...']
            ];
            ?>
